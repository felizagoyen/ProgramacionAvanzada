...
public class QuestionsResponse implements Serializable, Package {
	...
	public QuestionsResponse (){
		...
		questions.add(new StringQuestion("Qu� equipo pechea siempre al final del torneo?", 1));
		questions.add(new StringQuestion("Qui�n descubri� el continente de zona sur?", 2));
