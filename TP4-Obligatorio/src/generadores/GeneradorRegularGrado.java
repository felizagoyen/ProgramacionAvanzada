...
public class GeneradorRegularGrado implements Generador {
	private Integer numeroDeNodos;
	
	public GeneradorRegularGrado(Integer numeroDeNodos) {
	...
	public static void main(String[] args) {
		...
		GeneradorRegularGrado g = new GeneradorRegularGrado(numeroDeNodos);
		g.generar("grafo.in");
	}
}
