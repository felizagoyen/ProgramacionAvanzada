...
public class GeneradorAleatorioPorcentajeAdyacencia implements Generador{
	private Integer numeroDeNodos;
	private Integer porcentajeAdyacencia;
	
	public GeneradorAleatorioPorcentajeAdyacencia(Integer numeroDeNodos, Integer porcentajeAdyacencia) {
	...
	public static void main(String[] args) {
		...
		GeneradorAleatorioPorcentajeAdyacencia g = new GeneradorAleatorioPorcentajeAdyacencia(numeroDeNodos, porcentajeAdyacencia);
		g.generar("grafo.in");
	}
}
